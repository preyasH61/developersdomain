/*
Name of the module: Activat account, reset password via mail

Date of module Creation: 14/09/2021
...
const sendEmail = (to, url, txt, msg) => {
    ...
    const mailOptions = {
        ...
        to: to,
        subject: "Developers Domain",
        html: `
            <div style="max-width: 700px; margin:auto; border: 10px solid #ddd; padding: 50px 20px; font-size: 110%;">
            <h2 style="text-align: center; text-transform: uppercase;color: teal;">Welcome to Developer's Domain.</h2>
            <p>
                ${msg}
            </p>
